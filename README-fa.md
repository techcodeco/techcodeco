    ...
    <tr>
      <td align="center" valign="middle">
        ...
        <p align="center" style="margin: 0 0 20px 0; font-family: monospace; font-size: 15px; color: #aaaaaa;">
          ⛰️ بوکان · کردستان · ۲۰ سال ⛰️
        </p>
        <table dir="rtl" border="0" width="100%" style="font-family: monospace;">
          <tr>
            <td align="right" style="padding: 6px 12px; color: #FF6B6B;">📅</td>
            <td dir="rtl"  align="right" style="padding: 6px 12px; color: #ddd;"><strong style="color: #ffd700;">۶ ژوئن ۲۰۰۶</strong> · متولد بهار</td>
          </tr>
          <tr>
            <td align="right" style="padding: 6px 12px; color: #4ECDC4;">🎓</td>
            <td dir="rtl"  align="right" style="padding: 6px 12px; color: #ddd;"><strong style="color:#ffd700;">۵+ سال</strong> · شروع از ۱۵ سالگی · هیچ‌وقت متوقف نشدم</td>
          </tr>
          <tr>
            <td align="right" style="padding: 6px 12px; color: #FF6B6B;">💡</td>
            <td dir="rtl"  align="right" style="padding: 6px 12px; color: #ddd;">"کدنویسی هنر منه، منطق بوم نقاشی منه"</td>
          </tr>
          <tr>
            <td align="right" style="padding: 6px 12px; color: #FFD700;">🚀</td>
            <td dir="rtl"  align="right"  style="padding: 6px 12px; color: #ddd;">ساخت رویاها · هر بار یک کامیت</td>
          </tr>
        </table>
        <br />
...
<div align="center">
  ...
  <br>
  <details>
    <summary><b>⚙️ جادوی بک‌اند</b></summary>
    <br>
    <div>
  ...
  <br>
  <details>
    <summary><b>📱 جادوی موبایل</b></summary>
    <br>
    <div>
  ...
  <br>
  <details>
    <summary><b>🗄️ دیتابیس و ORM</b></summary>
    <br>
    <div>
  ...
  <details>
    <summary><b>🛠️ ابزارها و معماری</b></summary>
    <br>
    <div>
...
<div align="center">
  ...
  <h2>
    🎯 <b>الان روی چه چیزی کار می‌کنم؟</b> 🔥
  </h2>
  ...
  <table width="100%">
    <tr>
      <td align="center" width="25%" style="background: #0a0a0a; border-radius: 15px; padding: 15px; border: 1px solid #FF6B6B20;">
        ...
        <b>🔭 می‌سازم</b>
        <br>
        <i>اپلیکیشن‌های مقیاس‌پذیر MERN</i>
      </td>
      <td align="center" width="25%" style="background: #0a0a0a; border-radius: 15px; padding: 15px; border: 1px solid #4ECDC420;">
        ...
        <b>🌱 یاد می‌گیرم</b>
        <br>
        <i>میکروسرویس‌ها و طراحی سیستم</i>
      </td>
      <td align="center" width="25%" style="background: #0a0a0a; border-radius: 15px; padding: 15px; border: 1px solid #FF6B6B20;">
      ...
      <td align="center" width="25%" style="background: #0a0a0a; border-radius: 15px; padding: 15px; border: 1px solid #4ECDC420;">
        ...
        <b>⚡ حقیقت جالب</b>
        <br>
        <i>از ۱۵ سالگی کدنویسی رو شروع کردم!</i>
      </td>
    </tr>
   </table>
</div>
...
<div align="center">
  ...
  <h2>
    🌐 <b>بیا با هم ارتباط داشته باشیم</b> ✨
  </h2>
